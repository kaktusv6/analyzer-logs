...
#[AsCommand(
    name: 'analyze:logs:unavailable',
    description: 'Команда считывает логи, анализирует и выводит временные интервалы в которых доля отказов была ниже указанной',
)]
final class ServiceUnavailableLogsAnalyzeCommand extends Command
{
